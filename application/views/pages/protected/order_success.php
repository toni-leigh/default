		...
		if (1==$order_found)
		{
			// loop over the rows
		        foreach($order_items as $oi)
		        {
			        ...
			        // output the row html
			            ?>
			            <div class='oirow <?=$vrow_class; ?>'>
			                <span class='oirow_details'>
			                	<span class='oirow_qty'>
			                		<span class='oirow_qtyval'><?=$oi['qty']; ?></span>
			                		<span class='oirow_qtyx'>X</span>
		                		</span>
		                		<span class='oirow_name'><?=$oi['name']; ?></span>
		                		<span class='oirow_price'>@ <?=format_price($oi['price']); ?> each.</span>
		                		<span class='oirow_subtotal'><?=format_price($oi['subtotal'],2); ?></span>
			...
			// output
			    ...
			    <div id='prod_total_row' class='total_row'>
			        ...
			        <span id='pg_total_val' class='gt_val'>
			            <div id='prod_grand_total'>
			                <?=format_price($order_totals['product']); ?>
			            </div>
			        </span>
			    </div>
			    ...
			    <div id='post_total_row' class='total_row'>
			        ...
			        <span id='pg_total_val' class='gt_val'>
			            <div id='post_grand_total'>
			                <?=format_price($order_totals['postage']); ?>
			            </div>
			        </span>
			    </div>
			    ...
			    <div id='nv_total_row' class='total_row'>
			        ...
			        <span id='nv_total_val' class='gt_val'>
			            ...
			            <div id='nv_grand_total'>
			                <?=number_format($order_totals['total_nv'],2); ?>
			            </div>
			        </span>
			    </div>
			    ...
			    <div id='voucher_total_row' class='total_row'>
			        ...
			        <span id='v_total_val' class='gt_val'>
			            <div id='voucher_grand_total'>
			                <?=number_format($order_totals['voucher'],2); ?>
			            </div>
			        </span>
			    </div>
			    ...
			    <div id='total_row' class='total_row'>
			        ...
			        <span id='pg_total_val' class='gt_val'>
			            <span style='width:7px;float:left;'>&pound;</span>
			            <div id='grand_total'>
			                <?=number_format($order_totals['total'],2); ?>
			            </div>
			        </span>
			    </div>
			    <?php
