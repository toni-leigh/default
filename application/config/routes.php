...
// redirect to controllers to avoid category catch below
    ...
    $route['flag/([a-z0-9_]+)']='flag/$1';
    $route['image/([0-9]+)']='image_display/display_image/$1';    
    $route['map/([a-z_]+)']='map/$1';
    $route['message/([a-z_]+)']='message/$1';    
...
// node management
    ...
    $route['images/edit/([0-9]+)']='image_upload/show_edit_form/$1'; // shows a form for editing image thumbnail
    $route['images/save_edit/([0-9]+)']='image_upload/save_edit/$1'; // saves the edited thumbnail
    $route['images/save_all']='image_upload/set'; // saves all images from that page
